...
export const ServerChannel = ({
    ...
    return (
       <button onClick={onClick} className={cn(
        ...
        <p className={cn(
            "line-clamp-1 font-semibld text-sm text-zinc-500 group-hover:text-zinc-600 dark:text-zinc-400 dark:group-hover:text-zinc-300 transition",
        ...
        {channel.name === "general" && (
            <Lock className="ml-auto w-4 h-4 textzinc-500 dark:text-zinc-400"/>
        )}
       </button>
    )
}